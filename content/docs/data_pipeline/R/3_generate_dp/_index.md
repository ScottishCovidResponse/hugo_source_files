...
2. Choose an appropriate [filename]({{< ref "/docs/data_pipeline/R/1_versioning/_index.md" >}}):

   ``` R
   filename <- "0.1.0.toml"
   ```

3. Choose an appropriate [data product name]({{< ref "/docs/data_pipeline/R/2_dp_name/_index.md" >}}):
